...
if 'username' in form and 'password' in form:
    ...
    if authenticate(username,password):
        ...
        #attach a link:
        body+='''<center>
<div class = "center translucentBox"><a href="profile.py">Go To Profile Page</a><br></div>
</center>'''
    else:
        body += '''<center>
<div class = "center translucentBox">Failed to authenticate</div>
</center>'''
else:
    body = '''<center>
<div class = "center translucentBox">
	<h1 class = "title baguette">Log in:</h1>
	<form action="login.py">
	Username: <input type="text" name="username"><br>
	Password: <input type="password" name="password"><br>
	<input type="submit" value="log in" class = "buttonHover button">
	
</div>
</center>
<img src = '../images/toaster.gif' />
'''
