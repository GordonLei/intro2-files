...
print '''
    ...
    <body>
        <table class = "bar" border = '1'>
            <tr>''' + userName + '''</tr><tr>''' + ('''<td class = "HPBar">H''' * int(stats.split(',')[0])) + '''</td></tr><tr>''' + ('''<td class = "ManaBar">B''' * int(stats.split(',')[1])) + '''</td></tr><tr><td>Armor: ''' + stats.split(',')[2] + '''</td>''' +'''</tr>''' + '''<table class = "inventory">
            <tr>
                <td> HP Potions: </td>
